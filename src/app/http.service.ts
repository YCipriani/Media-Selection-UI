...
export class HttpService {
  ...
  listImages() {
    //line below is when searching for a term
    ...
    //Requests a list of 20 random photos from the unspash API
    return this.http_client.get("https://api.unsplash.com/photos/random?count=20&client_id=8432caa0c84fa9846b8de16a15206f888a2c03f2e0127ea61b08107caf8eaa7a");
